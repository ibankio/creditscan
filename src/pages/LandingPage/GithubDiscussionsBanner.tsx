...
const GITHUB_DISCUSSION_URL =
  "https://github.com/creditchainfoundation/creditchain-developer-discussions/discussions";
...
export function GithubDiscussionsBanner() {
  ...
  const text =
    "Ask your tech questions and hang out with the CreditChain developer community in the new developer discussions!";
